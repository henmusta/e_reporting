        ...
        ->addColumn('action', function ($row) {
          return
            ...
            <ul class="dropdown-menu">
              <li> <a href="#" data-bs-toggle="modal" data-bs-target="#modalEdit" data-bs-id="' . $row->id . '" data-bs-title="' . $row->title . '" data-bs-slug="' . $row->slug . '" data-bs-path_url="' . $row->path_url . '" data-bs-icon="' . $row->icon . '" class="edit dropdown-item">Edit</a></li>
