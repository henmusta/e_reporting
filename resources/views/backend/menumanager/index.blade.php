...
@section('css')
  ...
  <link href="{{ asset('assets/vendor_components/nestable/nestable.css') }}" rel="stylesheet" type="text/css"/>
@endsection
@section('script')
  ...
  <script src="{{ asset('assets/vendor_components/nestable/nestable.js') }}" type="text/javascript"></script>
  <script>
